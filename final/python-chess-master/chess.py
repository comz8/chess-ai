...
def run_game():
    ...
    playeravatar = pygame.transform.scale(playeravatar, (240, 240))
...
def welcome():
    ...
    textsurface = medfont.render(
        'Songseol Academic Research', False, (255, 255, 255))
    screen.blit(textsurface, (60, 100))
    ...
    # our names
    textsurface = myfont.render(
        'Kim Jaeho', False, (255, 255, 255))
    screen.blit(textsurface, (130, 420))

    textsurface = myfont.render(
        'Hwang Yeongjun', False, (255, 255, 255))
    screen.blit(textsurface, (490, 420))
